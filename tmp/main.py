...
from unscented_kalman_filter import geodetic_dynamics, hx

fx = geodetic_dynamics

dim_x = 4
dim_z = 2

# Get the historical ship data
lon, lat, dts = get_historical_ship_data(
    "/home/joaomorado/git_repos/ship-track-estimators/data/historical_ships/historical_ship_data.csv",
    "01203823",
)
